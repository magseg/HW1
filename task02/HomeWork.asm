; вариант 6: Разработать программу, которая вводит одномерный массив A[N], формирует новый массив B из элементов A, значение
; которых кратно введённому числу x.
...
section '.data' data readable writable
        ...
        strScanInt     db '%d', 0
        strX           db 'x = ', 0
        strXOutput db 'multiples x in A: ', 0
        strBVec        db '---B---', 10, 0
...
; 2) x input
        call XInput
; 3) Подсчёт кол-ва элементов в A, кратных x
        call VectorReady ; подготовка к проходу по массиву
        call VectorAScan ; подсчёт кол-ва элементов в A, кратных x
        call XWrite
