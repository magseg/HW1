...
void dine()
{
...

    {
        ...
        {
           {
              { "First philosopher", table, table.forks[0], table.forks[1] },
              { "Second philosopher",    table, table.forks[1], table.forks[2] },
              { "Third philosopher", table, table.forks[2], table.forks[3] },
              { "Fourth philosopher",      table, table.forks[3], table.forks[4] },
              { "Fifth philosopher", table, table.forks[4], table.forks[0] },
           }
        };
